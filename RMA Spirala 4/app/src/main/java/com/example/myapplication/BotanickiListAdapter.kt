...
class BotanickiListAdapter (private var biljke : List<Biljka>,private val biljkaRepository: BiljkaRepository, private val onItemClicked: (movie:Biljka) -> Unit) : RecyclerView.Adapter<BotanickiListAdapter.BiljkaViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BiljkaViewHolder, position: Int) {
        ...
        holder.biljkaPorodica.text = biljke[position].family
